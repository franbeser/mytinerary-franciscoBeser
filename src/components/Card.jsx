...
const Card = ({data}) => {
    ...
    const {name, country, image, description} = data
    return (
        ...
        <div className="p-2 flex flex-col items-center ">
            ...
            <a href={"/details/" + {name}} className="items-center px-3 py-2 text-sm font-medium  text-white bg-fuchsia-700 rounded-lg hover:bg-fuchsia-800 focus:ring-4 focus:outline-none focus:ring-blue-300" >
                Read more
            </a>
